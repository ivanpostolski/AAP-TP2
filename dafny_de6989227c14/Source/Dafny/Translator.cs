      ...
      if (expr is LiteralExpr) {
        ...
        switch (e.ResolvedOp) {
          ...
          case BinaryExpr.ResolvedOpcode.Mod: {
			  ...
			  builder.Add (new Bpl.AssumeCmd (expr.tok,Bpl.Expr.Lt(etran.TrExpr(e.E0),Bpl.Expr.Literal(2147483647))));
			  builder.Add (new Bpl.AssumeCmd (expr.tok,Bpl.Expr.Gt(etran.TrExpr(e.E0),Bpl.Expr.Literal(-2147483648))));
              CheckResultToBeInType(expr.tok, expr, expr.Type, locals, builder, etran);
            }
            break;
          default:
